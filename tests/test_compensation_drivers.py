...
class TestCompensationDrivers(unittest.TestCase):
    def test_sql_compensation_driver_query_generation(self):
        executed_queries = []
        def mock_db_exec(query: str, params: tuple):
        ...
        self.assertEqual(executed_queries[0][0], "DELETE FROM orders WHERE order_id = ?")
        self.assertEqual(executed_queries[0][1], ("ORD_999",))
